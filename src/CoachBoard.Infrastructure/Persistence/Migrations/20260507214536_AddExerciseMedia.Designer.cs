...
namespace CoachBoard.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260507214536_AddExerciseMedia")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoachBoard.Domain.Entities.ClientProgressPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ClientProgressRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientProgressRecordId");

                    b.HasIndex("ClientId", "TakenAt");

                    b.ToTable("ClientProgressPhotos", (string)null);
                });
            ...
            modelBuilder.Entity("CoachBoard.Domain.Entities.Exercise", b =>
                {
                    ...
                    b.HasIndex("IsGlobal", "CoachId");

                    b.ToTable("Exercises", (string)null);
                });

            modelBuilder.Entity("CoachBoard.Domain.Entities.ExerciseMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoachBoard.Domain.Entities.ClientProgressPhoto", b =>
                {
                    ...
                    b.HasOne("CoachBoard.Domain.Entities.ClientProgressRecord", "ClientProgressRecord")
                        .WithMany("Photos")
                        .HasForeignKey("ClientProgressRecordId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Client");

                    b.Navigation("ClientProgressRecord");
                });
